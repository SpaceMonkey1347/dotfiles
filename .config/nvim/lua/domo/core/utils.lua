...
local M = {}
-- reload mappings once on :source in mappings.lua
...
M.load_mappings = function (section, mapping_opt)
    vim.schedule(function()
        local mappings = require(MAPPINGS_PATH)
...
M.reload_mappings = function (section, mapping_opt)
    M.mappings_loaded_flag = false
    local mapping_path = vim.api.nvim_get_runtime_file(MAPPINGS_PATH_2, false)[1]
